...
public class TreeSetExam {
	...
	public static void main(String[] args) {
		...
		ts.add(new Integer(70));
		ts.add(new Integer(89)); // 지워진것 강제로 추가함.
		...
		// 부분 검색.
		NavigableSet<Integer> bet1 = ts.headSet(new Integer(82), false); // 앞에서부터 82까지 부분검색. false 82는 미포함.
		NavigableSet<Integer> bet2 = ts.headSet(new Integer(82), true); // 앞에서부터 82까지 부분검색. true 82는 포함.
		...
		NavigableSet<Integer> bet4 = ts.tailSet(new Integer(82), true); // 82부터 끝까지 부분검색. true 82는 포함.
